const NotFoundComponent = () => {
  return (
    <div className='no-file-found flex flex-col items-center justify-center py-8 px-4 text-center bg-gray-100 dark:bg-gray-800 rounded-lg shadow-md'>
      ...
      <h3 className='text-xl font-medium mt-4 text-gray-700 dark:text-gray-200'>File not found</h3>
      <p className='text-gray-500 dark:text-gray-400 mt-2'>The file you are looking for could not be located.</p>
    </div>
  )
}
